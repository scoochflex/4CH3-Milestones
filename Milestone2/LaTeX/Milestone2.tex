...
GitKraken affords adding additional remote repositories for a local repository. The newly added remote repository
can be hosted on GitHub, BitBucket, or just linked to using an URL. 
...
the modifications made in that commit.
...
the branch which is highlighted. GitKraken indicates that there are un-staged changes by having a dashed circle as apposed to a solid circle.
