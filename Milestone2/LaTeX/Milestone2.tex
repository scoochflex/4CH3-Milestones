...
in the application (things that the GUI prevents the user from doing) and the feedback
shown to the user. 
...
source control to be centralized. They want to be able to make changes to this code and 
...
those changes. This breaks down into a few basic git features that all users need access to.
...
machine. This application does allow the user to all changes that were made to a file, 
