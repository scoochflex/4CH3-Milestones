...
already and would have to switch to master in order to acheive this goal. The last action that the user
must take is to press the update button. This lessens the discoverability of the GUI becasue once again
