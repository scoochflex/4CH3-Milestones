...
\keywords{\plainkeywords}
  Git; GUI; SmartGit; SourceTree; GitKraken; GitHub; User interface.
...
\begin{figure*}
  \centering
  \includegraphics[width=1.75\columnwidth]{figures/SourceTree/constraints_stage_selected}
...
\begin{figure*}
  \centering
  \includegraphics[width=1.75\columnwidth]{figures/GitHub/GitHub-HTA1}
  \caption{GitHub HTA1}~\label{fig:GitHubHTA1}
\end{figure*}

\begin{figure*}
  \centering
  \includegraphics[width=1.75\columnwidth]{figures/GitHub/GitHub-HTA2}
  \caption{GitHub HTA2}~\label{fig:GitHubHTA2}
\end{figure*}

\begin{figure*}
  \centering
  \includegraphics[width=1.75\columnwidth]{figures/SourceTree/SourceTree-HTA1}
  \caption{SourceTree HTA1}~\label{fig:SourceTreeHTA1}
\end{figure*}

\begin{figure*}
  \centering
  \includegraphics[width=1.75\columnwidth]{figures/SourceTree/SourceTree-HTA2}
